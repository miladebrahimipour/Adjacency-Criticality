...
void gate::setDelay_Vth_sensitivity(int i)
{
	...
	Delay_Vth_sensitivity[i] = alpha * Delay_mean;;
}
...
void gate::setFan_in_Average_Criticality(double i)
{
	fan_in_Average_Criticality = i;
}


double gate::getFan_in_Average_Criticality()
{
	return fan_in_Average_Criticality;
}


void gate::setFan_out_Average_Criticality(double i)
{
	fan_out_Average_Criticality = i;
}


double gate::getFan_out_Average_Criticality()
{
	return fan_out_Average_Criticality;
}


void gate::setFan_out_number(int i)
{
	Fan_out_number = i;
}


int gate::getFan_out_number()
{
	return Fan_out_number;
}


void gate::setFan_in_number(int i)
{
	Fan_in_number = i;
}


int gate::getFan_in_number()
{
	return Fan_in_number;
}
